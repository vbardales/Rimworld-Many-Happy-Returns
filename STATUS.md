...
remaining:
  ...
  - unverified: publication of the 1.0.0 by CI. Decided by Virginie on 2026-09-25: semantic-release
    ...
    images 1 (the whole letter window), 2 (the wish in the Log tab) and 3 (the day's memory in the Needs tab) validated 2026-09-25; images 4 and 5 to present; the two memory scenarios are
